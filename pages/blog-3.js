                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog">
                                ...
                                <div className="content">
                                    ...
                                    <h3>
                                        <Link href="/blog-details">
                                            <a>Conversion Rate Optimization: Understanding the Sales</a>
                                        </Link>
                                    </h3>
                                    <Link href="/blog-details">
                                        <a className="blog-btn">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog">
                                ...
                                <div className="content">
                                    ...
                                    <h3>
                                        <Link href="/blog-details">
                                            <a>Finding the blocks of neighboring fields in a matrix</a>
                                        </Link>
                                    </h3>
                                    <Link href="/blog-details">
                                        <a className="blog-btn">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog">
                                ...
                                <div className="content">
                                    ...
                                    <h3>
                                        <Link href="/blog-details">
                                            <a>Business Data is changing the world’s view towards Green</a>
                                        </Link>
                                    </h3>
                                    <Link href="/blog-details">
                                        <a className="blog-btn">
